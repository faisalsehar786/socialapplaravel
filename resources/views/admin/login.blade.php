...
<head>
    ...
    <title>Hours Biddding Admin Panel</title>
            ...
            <div class="col-md-9 col-lg-12 col-xl-10">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex p-3">
                                <div class="flex-grow-1 bg-login-image" style="background-repeat: no-repeat;background-size: contain;background-image: url({{ asset('img/digicard.png') }});"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Welcome Admin Panel</h4>
                                    </div>
