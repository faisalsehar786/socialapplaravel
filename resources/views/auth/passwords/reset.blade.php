...
<main class="ant-layout-content app-login p-15">
    ...
    <div class="ant-row">
        <div class="ant-col ant-col-24">
            <form id="basic" class="ant-form ant-form-horizontal" action="{{ route('password.update') }}" method="POST">
                @csrf
                ...
                <div class="login-section"  @if(isset($settings) && !empty($settings->sectioncolor)) style="background:{{ $settings->sectioncolor }} !important" @endif>
                    <h1 class="login-title" @if(isset($settings) && !empty($settings->borderpanelcolor)) style="background:{{ $settings->borderpanelcolor }} !important" @endif>{{ __('Reset Password') }}</h1>
                    <div class="p-15">
                         @if (session('status'))
                                ...
                                <div class="ant-form-item-control-input">
                                    <div class="ant-form-item-control-input-content">
                                        <span class="input-background" id="basic_username" value="">
                                            ...
                                            <input type="email"  class="ant-input input @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="JohnDoe@gmail.com">
                                        </span>
                                    </div>
                                </div>
                                @error('email')
                                ...
                                <div class="ant-form-item-control-input">
                                    <div class="ant-form-item-control-input-content">
                                        <span class="input-background" id="basic_password">
                                            ...
                                            <input type="password"  class="ant-input input @error('password') is-invalid @enderror" name="password"  required autocomplete="password" autofocus placeholder="Password">
                                        </span>
                                    </div>
                                </div>
                                @error('password')
                            ...
                            <div class="ant-col ant-col-16 ant-form-item-control">
                                <div class="ant-form-item-control-input">
                                    <div class="ant-form-item-control-input-content">
                                        <span class="input-background" id="basic_password">
                                            <div class="img-wrap"><img class="icon anticon" src="{{ asset('frontend/assets') }}/img/secret.svg" alt="person"></div>
              <input type="password"  class="ant-input input @error('password') is-invalid @enderror" name="password_confirmation"  required autocomplete="password" autofocus placeholder="{{ __('Confirm Password') }}" >
                                        </span>
                                    </div>
                                </div>
                ...
                <div class="ant-row ant-form-item login-btn">
                    <div class="ant-col ant-col-16 ant-col-offset-8 ant-form-item-control">
                        <div class="ant-form-item-control-input">
                            <div class="ant-form-item-control-input-content">
                                <button type="submit" class="ant-btn ant-btn-primary"  @if(isset($settings) && !empty($settings->buttoncolor)) style="background:{{ $settings->buttoncolor }} !important" @endif><span>{{ __('Reset Password') }}</span></button>
                            </div>
                        </div>  
                    </div>
                </div>
